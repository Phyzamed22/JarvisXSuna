...
MODEL_NAME_ALIASES = {
    # TogetherAI models (kept for backward compatibility)
...
class AgentStartRequest(BaseModel):
    model_name: Optional[str] = "deepseek/deepseek-chat-v3-0324:free"
...
async def run_agent_background(
    ...
    try:
        ...
        agent_gen = run_agent(
            ...
            thread_manager=thread_manager, model_name=MODEL_NAME_ALIASES.get(model_name, model_name),
...
async def initiate_agent_with_files(
    prompt: str = Form(...),
    model_name: Optional[str] = Form("deepseek/deepseek-chat-v3-0324:free"),

...
class Configuration:
    ...
    # LLM API keys
    OPENROUTER_API_KEY: Optional[str] = None  # Primary API key for OpenRouter
    TOGETHERAI_API_KEY: Optional[str] = None  # Kept for backward compatibility
    GROQ_API_KEY: Optional[str] = None  # Kept for backward compatibility
    
   # Model configuration
    MODEL_TO_USE: Optional[str] = "deepseek/deepseek-chat-v3-0324:free"

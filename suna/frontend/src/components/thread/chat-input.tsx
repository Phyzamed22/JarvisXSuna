...
const DEFAULT_MODEL_ID = "deepseek/deepseek-chat-v3-0324:free"; // Define default model ID
...
export const ChatInput = forwardRef<ChatInputHandles, ChatInputProps>(({
  ...
  const modelOptions = [
    { id: "deepseek/deepseek-chat-v3-0324:free", label: "DeepSeek Chat V3 (Recommended)" },
    { id: "google/gemini-2.0-flash-exp:free", label: "Gemini 2.0 Flash (1M context)" },
    { id: "mistralai/mistral-nemo:free", label: "Mistral Nemo (128K context)" },
    { id: "meta-llama/llama-3.1-8b-instruct:free", label: "Llama 3.1 8B (131K context)" },
    { id: "mistralai/mistral-small-24b-instruct-2501:free", label: "Mistral Small 3 (32K context)" },
    { id: "deepseek/deepseek-r1:free", label: "DeepSeek R1 (163K context)" }
  ];
